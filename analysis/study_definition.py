...
ethnicity_combinations_5 = [f"{definition}_{other_var}" for definition, other_var in product(definitions,other_vars)]
ethnicity_combinations_16 = [f"{definition}_{other_var}" for definition, other_var in product(definitions_16,other_vars_16)]
