...
from create_variables_sus import demographic_variables, clinical_variables
...
other_vars_sus = ["white", "mixed", "asian", "black", "other"]
other_vars_16 = [
    "White_British",
    "White_Irish",
    "Other_White",
...
ethnicity_combinations_5 = [
    ...
    for definition, other_var in product(["ethnicity_new_5"], other_vars)
]
ethnicity_combinations_16 = [
    f"{definition}_{other_var}"
    for definition, other_var in product(["ethnicity_new_16"], other_vars_16)
]
